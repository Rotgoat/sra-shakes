(() => {
        ...
        const setTranslate = () => {
            ...
            for (let i = 0; i < slides.length; i += 1) {
                ...
                if (progress <= 1 && progress > -1) {
                    ...
                    if (swiper.browser && swiper.browser.isSafari && Math.abs(wrapperRotate) / 90 % 2 === 1) wrapperRotate += .001;
                }
    ...
    swiper_core_Swiper.use(modules);
    function initSliders() {
        if (document.querySelector(".brands-swiper")) new swiper_core_Swiper(".brands-swiper", {
            slidesPerView: 1,
            spaceBetween: 5,
            breakpoints: {},
            navigation: {
